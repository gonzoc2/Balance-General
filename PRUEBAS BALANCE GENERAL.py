...
def tabla_balance_acumulado():
    ...
    GOODWILL = GOODWILL  # ya definida previamente
    total_social = total_social  # valor obtenido de tu tabla de inversiones
    total_inversiones = total_inversiones  # valor de def tabla_inversiones()
